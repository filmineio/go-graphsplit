...
replace github.com/filedrive-team/filehelper v0.1.1 => github.com/filmineio/filehelper v0.1.1

replace github.com/filedrive-team/go-graphsplit v0.5.0 => github.com/filmineio/go-graphsplit v0.5.0
